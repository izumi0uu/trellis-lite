 ...
 * public update contract. `trellis-lite update` applies manifests where
 ...
 *   1. Query npm for all published versions of trellis-lite
...
function main() {
  ...
  if (newGaps.length > 0) {
    ...
    console.error(
      `\n` +
      `A version on npm without its local manifest breaks \`trellis-lite update\`\n` +
