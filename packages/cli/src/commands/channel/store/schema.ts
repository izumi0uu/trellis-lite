 ...
 *
 * Canonical source: `trellis-lite-core/channel`. This module is
...
import { buildContextEntries } from "trellis-lite-core/channel";
import type { ContextEntry } from "trellis-lite-core/channel";
