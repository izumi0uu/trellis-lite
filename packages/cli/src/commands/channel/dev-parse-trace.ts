...
/**
 * Dev-only command: feed a recorded Codex wire trace into the adapter and
 * print the resulting channel events as JSON lines.
 *
 ...
 */
export function parseTrace(file: string): void {
