...
```bash
trellis-lite channel create design-feedback \
  --type forum \
  --scope global \
...
```bash
trellis-lite channel post design-feedback opened \
  --scope global \
  --as main \
...
trellis-lite channel post design-feedback comment \
  --scope global \
  --as reviewer \
  --thread login-empty-state \
  --text-file /tmp/review.md

trellis-lite channel post design-feedback status \
  --scope global \
  --as main \
  --thread login-empty-state \
  --status closed

trellis-lite channel post design-feedback summary \
  --scope global \
  --as main \
  --thread login-empty-state \
...
```bash
trellis-lite channel messages design-feedback --scope global
trellis-lite channel forum design-feedback --scope global --status open
trellis-lite channel thread design-feedback login-empty-state --scope global
trellis-lite channel messages design-feedback --scope global --raw --thread login-empty-state
```
...
trellis-lite channel context add design-feedback \
  --scope global \
...
```bash
trellis-lite channel context list design-feedback --scope global
trellis-lite channel context list design-feedback --scope global --thread login-empty-state --raw
```
...
```bash
trellis-lite channel context delete design-feedback \
  --scope global \
  --thread login-empty-state \
  --raw "stale note"
```
...
```bash
trellis-lite channel title set design-feedback \
  --scope global \
  --title "Design feedback board"

trellis-lite channel title clear design-feedback --scope global
```
...
```bash
trellis-lite channel thread rename design-feedback old-key new-key \
  --scope global \
  --as main
```
...
```bash
trellis-lite channel create release-notes \
  --type forum \
  --scope global \
...
trellis-lite channel post release-notes opened \
  --scope global \
  --as main \
